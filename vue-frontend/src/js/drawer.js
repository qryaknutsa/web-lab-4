export default {
    data() {
        ...
        restorePoints: function (R) {
            ...
            this.ctx.fillStyle = '#d6ad9f';
            this.ctx.strokeStyle = '#714843';
            this.ctx.font = '12px serif';

            //II
            this.ctx.beginPath();
            this.ctx.moveTo(width / 2 - R, height / 2);
            this.ctx.lineTo(width / 2, height / 2);
            this.ctx.lineTo(width / 2, height / 2 - R);
            this.ctx.fill();
            this.ctx.beginPath();
            this.ctx.arc(width / 2, height / 2, R, Math.PI, -Math.PI / 2, false);
            this.ctx.fill();

            //I
            this.ctx.fillRect(width / 2, height / 2 - R / 2, R, R / 2); //II
